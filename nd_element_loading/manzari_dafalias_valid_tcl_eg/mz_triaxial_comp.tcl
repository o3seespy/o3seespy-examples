...
# Create recorders
recorder Node    -file disp.out   -nodeRange 1 8 -dof 1 2 3 disp
recorder Node    -file press.out  -time -nodeRange 1 8 -dof 4     vel
recorder Element -file stress.out stress
recorder Element -file strain.out strain
