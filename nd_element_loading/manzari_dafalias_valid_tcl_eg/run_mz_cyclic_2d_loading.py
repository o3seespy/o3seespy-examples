...
def run_mz_et(sl, csr, esig_v0=101.0e3, static_bias=0.0, n_lim=100, k0=0.5, runfile=None, water_bulk_mod=2.2e6, strain_limit=0.03, strain_inc=5.0e-6, cached=0):
...
if __name__ == '__main__':
    ...
    stress, strain, ppt, disps = run_mz_et(sl, csr=csr, n_lim=20, strain_limit=0.03,
    ...
    strains_tcl = np.loadtxt('Cycstrain.out')
    sps[1].plot(strains_tcl[:, 3], stresses_tcl[:, 3], label='Tcl', c='r', ls='--')
