...
def run():
    ...
    if pid == 0:
        ...
        o3.Mass2D(osi, nds[3], 100.0, 100.0)
    ...
    print('0) Node 4: ', [o3.get_node_coords(osi, nds[3]), o3.get_node_disp(osi, nds[3])])
    ...
    o3.analyze(osi, 10, 0.0001)

    print('1) Node 4: ', [o3.get_node_coords(osi, nds[3]), o3.get_node_disp(osi, nds[3])])
    ...
    print('2) Node 4: ', [o3.get_node_coords(osi, nds[3]), o3.get_node_disp(osi, nds[3])])
    o3.stop(osi)
